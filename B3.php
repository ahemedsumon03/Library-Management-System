...
<?php include('navbar.php'); ?>
	...
	<img src="http://localhost/images/B3.jpg" alt="" />
	<h3>Computer Science Distilled: Learn the Art of Solving Computational Problems<br /></h3>
	<h4>Wladston Ferreira Filho</h4>
<p>
