			   ...
			   <div class="alert alert-info">
						...
						<!--  -->
								    <ul class="nav nav-pills">
										...
										<li><a href="old_books.php">Used Books</a></li>
										<li><a href="lost.php">corrupted Books</a></li>
										<li><a href="damage.php">Damage Books</a></li>
										<li><a href="sub_rep.php">Replacement</a></li>
									</ul>
						<!--  -->
						<center class="title">
						<h1>Books List</h1>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">
                                ...
                                <tbody>
                                  ...
                                  <?php	
								    ...
								    $user_query=mysqli_query($con,"select * from book where status != 'Archive'")or die(mysql_error());
